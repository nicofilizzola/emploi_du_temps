...
final class Version20210407092151 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE equipment_request (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, user_id INT NOT NULL, equipment_id INT NOT NULL, subject_id INT NOT NULL, tds LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', tps LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', note VARCHAR(255) NOT NULL, INDEX IDX_4DEC4070613FECDF (session_id), INDEX IDX_4DEC4070A76ED395 (user_id), INDEX IDX_4DEC4070517FE9FE (equipment_id), INDEX IDX_4DEC407023EDC87 (subject_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
