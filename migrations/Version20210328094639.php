 ...
 */
final class Version20210328094639 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE preference (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, datetime DATETIME NOT NULL, state TINYINT(1) DEFAULT NULL, note VARCHAR(255) DEFAULT NULL, INDEX IDX_5D69B053613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE preference DROP FOREIGN KEY FK_5D69B053613FECDF');
